...
// // Using flatMap and map to extract ratings from each product's reviews
// let ratings = datas.products.flatMap((product) =>
//   product.reviews.map((review) => review.rating)
// );

// console.log(ratings);

// let rst = datas.products.flatMap((d) =>
//   d.reviews.filter((s) => s.reviewerEmail === "natalie.price@x.dummyjson.com")
// );
// console.log(rst);
// let rst = datas.products.map((d) => d.description);
// console.log(rst);

// let exData = [];
// for (let i = 0; i < datas.products.length; i++) {
//   exData.push(datas.products[i].reviews.map((s) => s.rating));
// }
// console.log(exData);
...
// let data1 = exData.filter((e) => e.data?.Capacity && e.data?.Generation);
...
// const data1 = products.map((s) => s.brand);
// console.log(data1);

const exData1 = products.flatMap((s) => s.reviews.map((d) => d.reviewerEmail));
console.log(exData1);
...
const names = ["latha", "suma", "rama"];
console.log(names);

let num1 = [1, 2, 3, 4, 5];
let num2 = [6, 7, 8, 9];
let exSpread = [...num1, ...num2];
console.log(exSpread);

const [a, ...rest] = [1, 2, 3, 4, 5, 6, 7, 8, 9];
console.log(a);
console.log(rest);
...
const employees = {
  males: [
    ...
    },
    {
      ...
      projects: [
        {
          projectName: "online tickets booking app",
          role: "javade eloper",
          duration: "2 months",
        },
      ],
...
let emp = employees.males.map((v) => v.id);
console.log(emp);
import { add, mulplay } from "./optionaChaining";
// let emp = employees.females.flatMap((s) =>
//   s.projects.filter((e) => e.role).map((d) => d.role)
// );
// console.log(emp);
// let emp = employees.males.map((s) => s.projects.map((d) => d.role));
// console.log(emp);

// let emp = employee.females.flatMap((e) =>
//   e.certifications.map((v) => v.issuedBy)
// );
// let emp = employee.females.map((s) => s.experience.toString());
// let emp = employee.males.flatMap((s) =>
//   s.certifications.map((s) => s.issuedBy)
// );
// console.log(emp);

// let emp = [];
// for (let i = 0; i < employee.males.length; i++) {
//   emp.push(employee.males[1].salary);
// }
// // console.log(emp);
// let num = [6, 7, 8, 9, 10];
// function greet() {
...
// const people = ["latha", "geetha", "suma"];
// console.log(people);
...
// const { j, ...rest2 } = { j: 20, b: 30, c: 40, d: 50 };
// console.log(j);
// console.log(rest2);

// function exDeafult(name = "deafultparam") {
